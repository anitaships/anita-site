...
const baseURL: string = "https://anitaliu.com";
...
const style: StyleConfig = {
  theme: "dark", // lead with deep-green mystery (清冷/神秘); user can still toggle
  neutral: "slate", // cool, calm base — 清冷
  brand: "emerald", // deep green — vitality + mystery (深祖母绿)
